...
import labsheet10.sampleprogram1.PostGraduate;
import labsheet10.sampleprogram1.UnderGraduate;
...
public class TestInterface {
     public static void main(String args[]) {
			...
			PermanentLecturer l1 = new PermanentLecturer("Thomas Quinas","Dublin","31-12-1984",52673,"");

			System.out.println("\n\n"+l1);

			TemporaryPermanent t1 = new TemporaryPermanent();
     	}	   
}