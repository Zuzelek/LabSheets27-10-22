...
public class TestAnimal {
	public static void main( String args[]) {
	    ...
	    System.out.println("Calling the 4-argument constructor to create a rat object");
	    Animal animal3 = new Animal("Rat",new String[]{"Europe","America","Africa","Asia"},0.2,5);

	    System.out.println("Calling the 4-argument constructor to create a polar bear object....");
